...
def fake_lookup_food(query, data_type):
    ...
    MOCK_NUTRITION = {
        ...
        "rice white long grain enriched raw":   (365,  7.1,  0.7, 80.0,  1.3, 0.80, 1.09, 0.00,   8,  28, 115, 25,    0, 0.0, 0.0, 0.11, 0.1),
        "wheat flour white all purpose enriched":(364, 10.3,  1.0, 76.3,  2.7, 1.17, 0.70, 0.00,  26,  15, 107, 22,    0, 0.0, 0.0, 0.06, 0.3),
        "pasta dry enriched":               (371, 13.0,  1.5, 74.7,  3.2, 1.30, 1.41, 0.00,   7,  21, 223, 53,    0, 0.0, 0.0, 0.30, 0.1),
